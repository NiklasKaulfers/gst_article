...
\subsection{GitHub Copilot mit GPT 5o-mini}
    ...
    hat die KI dann auf\\ \texttt{java -jar lib/junit-platform-console-standalone-1.11.0-M2.jar\\ --class-path build/test-classes:build/classes/java/main --scan-class-path}\\
    gewechselt. 
...
\chapter{KI-Nutzung}
\begin{lstlisting}[label={pro:testingPrompt}, caption={Test mit GitHub Copilot}]
