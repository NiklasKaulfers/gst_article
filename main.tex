...
\chapter{Einleitung}
{
    ...
    Im Verlauf der Arbeit sind \underline{unterstrichene} und \textit{kursive} Textabschnitte. 
...
\section{Qualitätsplanung}
    ...
    Eine solche Qualitätsplanung wurde auch hier vorgenommen\footnote{\ref{gph:testQualityPlan}, Qualitätsplanung}.
...
\chapter{Grafiken}
    ...
    \newpage
    \begin{figure}
        \caption{Planung der Tests (nach \fullcite[pp.93]{baresi2006introduction})}\label{gph:testQualityPlan}
        \begin{center}
            \begin{tabular}{ | c | c | }
                \hline
                ...
                \hline
                Approach & Unit Tests mit Grenzwerten oder \\
                \hline
                Pass/Fail cirteria & Alle Funktionen verhalten sich wie erwartet \\
                \hline 
                Suspension and resumption criteria & 
                    \makecell{Codequalität zu niedrig bzw unlesbar:\\Codeverbesserungen sind umgesetzt}
                    \newline
                    \makecell{Kritischer Error/Crash:\\Fix des kritischen Errors}
                    \\
                \hline
                ...
                \hline 
                Environment needs & JUnit, Java correto 23 \\
                \hline
            \end{tabular}
        \end{center}
    \end{figure}
