...
\section{Qualitätssicherung}
    ...
    Daraus kann auch die inkonsistente Codequalität hervorgeleitet werden.
    So sind Kommentare in sowohl deutsch als auch englisch und einige Codeabschnitte sind deutlich besser lesbar als andere.
    Somit ist das Projekt langfristig schwer aufrecht zuerhalten und zu erweitern. 
...
\subsection{Integration Tests - Erstellung und Abspeicherung eines Speichercodes}
    ...
    Auch ist das Verhalten interssant, für den Fall das kein Speicherstand existiert und versucht wird einen zu laden.\\
    ...
    Für den Testablauf muss hier nach jedem Durchlauf der Zustand der Datein wieder zum ausgangszustand zurückgebracht werden.
