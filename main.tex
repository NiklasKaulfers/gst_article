...
\section{Unit Tests - ist das Ende einer Spalte erreicht}
    Um zu schauen, ob weiteres platzieren von Steinen in einer Spalte erlaubt ist gibt es eine Funktion isTopOfColumn.
    Diese überprüft, ob die aktuelle Menge an Steinen in einer Spalte die Höhe des Spielfelds erreicht hat.\\
