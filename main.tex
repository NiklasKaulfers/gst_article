...
\chapter{Aufbau}
\section{Testobjekt}
Das Projekt, an welchem die Tests durchgeführt wurden ist ein Gemeinschaftsprojekt des Matrikels iib23 aus dem Modul Objektorientierte Programmierung. 
Es handelt sich hierbei um eine Implementation des Spiels Vier Gewinnt, einem bekannten und relativ leicht verständlichem Strategiespiel. Man kann dieses Spiel zu zweit Spielen, 
im Fall des Projektes, lokal gegen einen anderen Spieler oder gegen einen Computergegner. Das Spiel hat zudem ein GUI (Graphical User Interface), 
welches den Spielstand visualisiert und entsprechende Aktionen für den Spieler erlaubt.\\
