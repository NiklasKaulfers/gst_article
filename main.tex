...
\subsection{Claude Sonnet 4.5 im Browser}
    ...
    Schnell entsteht hierbei ein Problem, so ist der Packagename nicht passend mit dem tatsächlichen Punkt, an dem die Datei eingestzt werden soll.
    ...
    Auch hierfür musste zuerst der Prompt\ \ref{pro:promptAfterTest} verwendet werden, da Claude nicht selbstständig soetwas erledigt.
    ...
    Die Testfälle sind wieder sehr gut und stimmen mit den vorherkommenden Unittests überein.
