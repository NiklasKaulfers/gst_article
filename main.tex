...
\section{Qualitätsplanung}
    Um eine hohe Qualität der Tests sicherzustellen sollten gewisse Elemente und die damit verbundenen Anforderungen vor der tatsächlichen Umsetzung der Tests aufgelistet werden\footfullcite{baresi2006introduction}.
    ...
    \begin{figure}
        ...
        \begin{center}
            \begin{tabular}{  | c | c | }
                ...
                Test Items & blah \\
                \hline
                Features to be tested & blah \\
                \hline
                Features not to be tested & blah \\
                \hline
                Approach & blah \\
                \hline
                Pass/Fail cirteria & blah \\
                \hline 
                Suspension and resumption criteria & blah \\
                \hline
                Risks and contingencies & blah \\
                \hline
                Deliverables & blah \\
                \hline 
                Tasks \& Schedule & blah \\
                \hline 
                Staff \& responsibilities & blah \\
                \hline 
                Environment needs & blah \\
                \hline
            \end{tabular}
        \end{center}
    \end{figure}
