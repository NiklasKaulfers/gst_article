...
\subsection{Integration Tests - Laden und speichern des Spielstands}
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}[node distance=3cm]
            ...
            \node (play) [process, below of=user1] {Aktionen auf dem Spielfeld\\Updaten des Boards};
            \node (loadGame) [process, left of=user1, xshift=-2cm] {Ladenknopf};
            \node (createSavecode) [process, below of=pressSave] {erstellen der\\Speicherdatei};
